use std::{cmp::min, io, sync::{Arc, Mutex}, time::Instant};

use futures::{pin_mut, StreamExt};
use log::{debug, info};
use ratatui::{buffer::Buffer, crossterm::event::{self, Event, KeyCode, KeyEventKind}, layout::{Constraint, Layout, Margin, Rect}, symbols::scrollbar, text::Text, widgets::{Paragraph, Scrollbar, ScrollbarOrientation, ScrollbarState, Widget}, DefaultTerminal, Frame};

use crate::{chat::{Chat, StreamedChatResponse}, model::param::ModelMessage, tui::{inputarea::InputArea, messageblock::MessageBlock, messagetext::MessageText}};
